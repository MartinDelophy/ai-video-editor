...
- **2026-09-26** — Storyboards Sanity : un espace facultatif permet de modifier scripts et plans, de les approuver avec contrôle de version et de les ajouter à la timeline avec des médias locaux et des notes modifiables. Le montage reste local et les nouveaux contrôles couvrent 13 langues. L’espace déployé utilise Astro et partage le composant de révision React.
