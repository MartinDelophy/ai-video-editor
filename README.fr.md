...
- **31 août 2026 — Préparation accélérée des grandes vidéos :** l’import local crée une pellicule adaptée à la machine. Les vidéos de la bibliothèque affichent d’abord la progression réelle du téléchargement, puis la préparation des images ; une version bornée et la vraie première image évitent une fausse zone noire. Les vignettes exactes remplissent d’abord la zone visible, puis le reste par subdivision des milieux ; la cellule sous la tête de lecture suit toujours l’image d’aperçu en direct.
- **29 août 2026 — Connecteurs de génération locale :** ajout de plugins séparés pour ComfyUI et Stable Diffusion WebUI/Forge. ComfyUI exécute des workflows API Format sur une adresse de bouclage et importe les images ou vidéos ; WebUI utilise les vraies API txt2img/img2img. Les résultats rejoignent automatiquement My assets et l’intégration générique Hugging Face Spaces a été supprimée.
