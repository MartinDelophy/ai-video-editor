...
- **August 29, 2026 — Browser generation plugins:** limited the responsive Plugins workspace to Puter.js and Hugging Face Spaces. Puter now uses real popup authentication and browser-direct, user-paid image/video generation with completed media delivered to My assets; Spaces can be validated, embedded, and imported through their output URL without pretending that every Gradio API has the same schema.
