...
const PICTURE_IN_PICTURE_COPY = {
  zh: { pictureInPicture: "画中画", overlayTrack: "画中画", dropAsOverlay: "作为画中画", appendAfter: "添加到后面", dropSlot: "放置位置", layoutPresets: "布局预设", moveLayerUp: "上移一层", moveLayerDown: "下移一层", overlayTiming: "时间与图层", clipStart: "开始时间", clipDuration: "持续时间", layer: "图层", overlayMute: "静音视频原声" },
  en: { pictureInPicture: "Picture in picture", overlayTrack: "Overlay", dropAsOverlay: "Add as picture in picture", appendAfter: "Append to sequence", dropSlot: "Drop position", layoutPresets: "Layout presets", moveLayerUp: "Move layer up", moveLayerDown: "Move layer down", overlayTiming: "Timing & layer", clipStart: "Start time", clipDuration: "Duration", layer: "Layer", overlayMute: "Mute video audio" },
  ja: { pictureInPicture: "ピクチャーインピクチャー", overlayTrack: "オーバーレイ", dropAsOverlay: "ワイプとして追加", appendAfter: "後ろに追加", dropSlot: "配置位置", layoutPresets: "レイアウトプリセット", moveLayerUp: "レイヤーを上へ", moveLayerDown: "レイヤーを下へ", overlayTiming: "時間とレイヤー", clipStart: "開始時間", clipDuration: "長さ", layer: "レイヤー", overlayMute: "動画音声をミュート" },
  ko: { pictureInPicture: "화면 속 화면", overlayTrack: "오버레이", dropAsOverlay: "오버레이로 추가", appendAfter: "뒤에 추가", dropSlot: "놓을 위치", layoutPresets: "레이아웃 프리셋", moveLayerUp: "레이어 올리기", moveLayerDown: "레이어 내리기", overlayTiming: "시간 및 레이어", clipStart: "시작 시간", clipDuration: "길이", layer: "레이어", overlayMute: "비디오 음소거" },
  es: { pictureInPicture: "Imagen en imagen", overlayTrack: "Superposición", dropAsOverlay: "Añadir como superposición", appendAfter: "Añadir al final", dropSlot: "Posición de destino", layoutPresets: "Diseños predefinidos", moveLayerUp: "Subir capa", moveLayerDown: "Bajar capa", overlayTiming: "Tiempo y capa", clipStart: "Inicio", clipDuration: "Duración", layer: "Capa", overlayMute: "Silenciar audio" },
  fr: { pictureInPicture: "Image dans l’image", overlayTrack: "Incrustation", dropAsOverlay: "Ajouter en incrustation", appendAfter: "Ajouter à la suite", dropSlot: "Position de dépôt", layoutPresets: "Préréglages de disposition", moveLayerUp: "Monter le calque", moveLayerDown: "Descendre le calque", overlayTiming: "Temps et calque", clipStart: "Début", clipDuration: "Durée", layer: "Calque", overlayMute: "Couper l’audio" },
  de: { pictureInPicture: "Bild-in-Bild", overlayTrack: "Overlay", dropAsOverlay: "Als Überlagerung hinzufügen", appendAfter: "Hinten anfügen", dropSlot: "Ablageposition", layoutPresets: "Layout-Vorlagen", moveLayerUp: "Ebene nach oben", moveLayerDown: "Ebene nach unten", overlayTiming: "Zeit und Ebene", clipStart: "Startzeit", clipDuration: "Dauer", layer: "Ebene", overlayMute: "Video stummschalten" },
  pt: { pictureInPicture: "Picture-in-picture", overlayTrack: "Sobreposição", dropAsOverlay: "Adicionar como sobreposição", appendAfter: "Adicionar ao final", dropSlot: "Posição de destino", layoutPresets: "Predefinições de layout", moveLayerUp: "Subir camada", moveLayerDown: "Descer camada", overlayTiming: "Tempo e camada", clipStart: "Início", clipDuration: "Duração", layer: "Camada", overlayMute: "Silenciar vídeo" },
  th: { pictureInPicture: "ภาพซ้อนภาพ", overlayTrack: "ภาพซ้อน", dropAsOverlay: "เพิ่มเป็นภาพซ้อน", appendAfter: "เพิ่มต่อท้าย", dropSlot: "ตำแหน่งวาง", layoutPresets: "รูปแบบสำเร็จรูป", moveLayerUp: "เลื่อนเลเยอร์ขึ้น", moveLayerDown: "เลื่อนเลเยอร์ลง", overlayTiming: "เวลาและเลเยอร์", clipStart: "เวลาเริ่ม", clipDuration: "ระยะเวลา", layer: "เลเยอร์", overlayMute: "ปิดเสียงวิดีโอ" },
  vi: { pictureInPicture: "Hình trong hình", overlayTrack: "Lớp phủ", dropAsOverlay: "Thêm làm lớp phủ", appendAfter: "Thêm vào cuối", dropSlot: "Vị trí thả", layoutPresets: "Bố cục mẫu", moveLayerUp: "Đưa lớp lên", moveLayerDown: "Đưa lớp xuống", overlayTiming: "Thời gian và lớp", clipStart: "Bắt đầu", clipDuration: "Thời lượng", layer: "Lớp", overlayMute: "Tắt âm thanh video" },
  ru: { overlayTiming: "Время и слой", clipStart: "Время начала", clipDuration: "Длительность", layer: "Слой", overlayMute: "Отключить звук видео" },
};
...
export function createTranslator(languageId) {
  ...
  const specializedCopy = Object.assign({}, ...[
    EXPORT_RENDER_COPY, MEDIA_COMPATIBILITY_COPY, COMMUNITY_LINKS_COPY, VECTOR_LIBRARY_COPY, PROJECT_CHROME_COPY, CORE_LABEL_COPY, MOBILE_DRAWER_COPY, MOBILE_CLIP_ACTION_COPY,
    ...
    AUTO_EDIT_RESULT_COPY, IMAGE_AI_CAPTION_COPY, PICTURE_IN_PICTURE_COPY, VECTOR_STATE_COPY, VECTOR_DOCUMENT_COPY, VECTOR_ADVANCED_COPY,
    SRT_IMPORT_COPY,
