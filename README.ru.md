...
- **27 августа 2026 — Точный монтаж на таймлайне:** добавлены прокрутка содержимого видео в пределах исходного материала, сдвиг трёх клипов с синхронной подрезкой соседей и выбор точки монтажа с покадровой прокаткой стрелками. Все режимы сохраняют основную видеодорожку без разрывов, учитывают блокировки и границы источника, показывают результат перетаскивания в реальном времени и локализованы на 11 языков. Вертикальные и 9:16 миниатюры теперь заполняют ячейку центральным кадрированием без чёрных полос.
- **26 августа 2026 — Монтаж со сдвигом с учётом блокировки:** на панели таймлайна появился явный режим сдвига. При перетаскивании материала на основную дорожку ещё до отпускания открывается слот его длительности, а последующие клипы и точки переходов сдвигаются вместе. У основных клипов появился передний маркер скользящей границы, а вставка «картинка в картинке» показывает реальную позицию и длительность на целевой строке. Вставка, дублирование, удаление и изменение длительности перемещают подходящие временные клипы на ту же величину, сохраняют активные связи субтитров и аудио, выводят связанный исходный звук из видеоряда и не двигают заблокированные дорожки.
- **26 августа 2026 — Переносимое разделение видео:** исправлена команда Agent `visual.split`: оба соседних клипа после повторного открытия сохраняют ссылку на исходный файл в архиве, а браузерный экспорт включает всё видео и встроенный исходный звук.
- **24 августа 2026 — Ритмическая волна клика:** добавлен редактируемый эффект в стиле osu! с детерминированными случайными точками попадания, музыкальными размерами и BPM четвертной ноты, одной преломляющей водяной волной на весь кадр для каждого клика, синхронным переходом от серого к цвету, правой панелью настроек, одинаковым результатом предпросмотра и экспорта и локализацией на 11 языков.
