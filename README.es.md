...
- **2026-09-26** — Storyboards de Sanity: una mesa opcional permite editar guiones y planos, revisar y aprobar con control de versión y añadir planos a la línea de tiempo con medios locales y notas editables. El editor mantiene su enfoque local y los nuevos controles admiten 13 idiomas. La mesa desplegada usa Astro y comparte el componente de revisión React.
