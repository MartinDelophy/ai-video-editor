...
- **31 de agosto de 2026 — Preparação mais rápida de vídeos grandes:** a importação local cria uma faixa adaptada ao computador. Vídeos da biblioteca mostram primeiro o progresso real do download e depois a preparação dos quadros; uma versão limitada e o quadro inicial exato evitam um trecho preto artificial. Miniaturas exatas preenchem primeiro a área visível e depois o restante por subdivisão de pontos médios; a célula sob o cursor acompanha sempre o quadro real da prévia ao vivo.
