...
- **2026-09-26** — Раскадровки Sanity: дополнительное рабочее пространство для сценариев и кадров, проверки и одобрения с контролем версий и добавления кадров на таймлайн с локальными медиа и редактируемыми заметками. Редактор сохраняет локальный подход; новые элементы переведены на 13 языков.
