...
- **2026년 8월 31일 — 대용량 비디오 준비 속도 개선:** 로컬 가져오기는 컴퓨터 성능에 맞춘 필름스트립을 만듭니다. 소재 라이브러리의 온라인 비디오는 실제 다운로드 진행률을 먼저 보여 준 뒤 프레임 준비로 전환합니다. 정확한 썸네일은 현재 보이는 구간을 먼저 채우고 화면 밖은 중점 분할 순서로 점진적으로 보완하며, 재생 헤드 셀은 항상 실시간 미리보기의 실제 프레임을 따릅니다.
