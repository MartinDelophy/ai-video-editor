...
- **2026-09-26** — Storyboards do Sanity: um espaço opcional permite editar roteiros e planos, revisar e aprovar com verificação de versão e adicionar planos à linha do tempo com mídia local e notas editáveis. O editor mantém o processamento local e os novos controles oferecem 13 idiomas. O espaço publicado usa Astro com o componente compartilhado de revisão React.
