...
- **2026-09-26** — Sanity 스토리보드: 선택형 작업대에서 대본과 장면 편집, 버전 확인을 포함한 검토·승인, 로컬 소재를 연결한 타임라인 추가를 지원합니다. 장면 메모는 편집 가능하며 로컬 우선 편집과 13개 언어 지원을 유지합니다. 배포 작업대는 Astro를 사용하며 React 검토 도구를 공유합니다.
