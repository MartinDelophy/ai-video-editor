...
- **2026-09-17 — Точный монтаж и проверка через WebMCP:** 21 браузерный инструмент поддерживает 26 проверяемых операций, включая перемещение и обрезку исходника клипов, преобразование наложений, стиль и позицию субтитров и формат проекта. Агенты могут получать готовые кадры и аудиофрагменты, запускать локальную озвучку или распознавание с прогрессом и отменой и проверять результат перед вставкой. Новые элементы управления и сообщения доступны на всех 13 языках интерфейса.
- **2026-09-15 — Экспорт отредактированного аудио:** при экспорте аудиоклипа теперь учитываются обрезка, скорость воспроизведения, громкость, плавное нарастание и затухание звука, а также эффекты акустического пространства. Отдельные клипы и микс всей временной шкалы можно экспортировать в WAV или MP3. Наряду с экспортом видео доступен экспорт только аудио.
- **2026-09-14 — Исправление экспорта и повторная попытка:** клипы с однотонным фоном и ключевыми кадрами непрозрачности теперь корректно экспортируются даже без маски человека. При сбое сообщение об ошибке остаётся на экране, а экспорт можно повторить с теми же настройками.
- **2026-09-14 — Производительность больших проектов:** импорт уменьшает нагрузку на основной поток. Кеширование расчёта аудиодорожек, облегчённая отрисовка звуковых волн и сокращение лишних перемещений по аудио снижают нагрузку при перетаскивании курсора и воспроизведении. Медиафайлы, время клипов, инструменты монтажа, эффекты и поведение экспорта сохранены. При импорте отображается фактический прогресс; редактирование доступно сразу после восстановления медиафайлов, а миниатюры продолжают уточняться в фоновом режиме.
- **11 сентября 2026 — Монтаж и экспорт видео через WebMCP:** 15 браузерных инструментов позволяют проверять правки субтитров, громкости и плавного изменения звука, маркеров, разделение/удаление/дублирование основных клипов, поиск и вставку доступных материалов и «картинку в картинке». Агенты могут подготовить параметры экспорта, запустить настоящий экспортёр редактора, проверить прогресс и данные итогового файла или отменить задачу. Пакетные правки сохраняют проверку конфликтов, сдвиг клипов при монтаже, блокировки дорожек и отмену; повторные запросы не вызывают повторных загрузок. Инструменты и просмотр правок переведены на все 13 языков интерфейса.
