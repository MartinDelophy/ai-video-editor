...
- **2026-09-26** — Раскадровки Sanity: дополнительное рабочее пространство для сценариев и кадров, проверки и одобрения с контролем версий и добавления кадров на таймлайн с локальными медиа и редактируемыми заметками. Редактор сохраняет локальный подход; новые элементы переведены на 13 языков. Развёрнутая рабочая область использует Astro и общий компонент проверки React.
- **2026-09-21 — Удаление пауз:** Smart локально находит длинные речевые паузы с Silero VAD. Можно проверить и выбрать участки для синхронного сокращения основного видео и исходного звука, настроить порог и интервал, включить сдвиг дорожек, отменить анализ или правку. Интерфейс на 13 языках.
