...
- **2026-09-26** — Sanity storyboards: an optional workbench now supports script and shot editing, revision-checked review and approval, and appending approved shots with locally matched media and editable timeline notes. The editor stays local-first; the new controls support 13 languages. The deployed workbench uses Astro with the shared React review tool.
