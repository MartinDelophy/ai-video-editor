...
- **2026-09-20 — Привязка указателя к маркерам:** При перетаскивании белого указателя кадр обновляется в реальном времени, а указатель привязывается к маркерам и границам диапазонов с общей линией выравнивания и временем. Удерживайте Alt для свободного перемещения. До редактирования отображается Готово, после — Применить изменения.
