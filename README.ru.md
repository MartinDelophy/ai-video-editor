...
- **12 сентября 2026 — Значок Best AI Tool:** на экране выбора языка при первом запуске рядом с брендом Timeline Studio появился значок Best AI Tool. Расположение адаптируется к компьютерам и телефонам; нажатие открывает внешний сайт в новой вкладке.
