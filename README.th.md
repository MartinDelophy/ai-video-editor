...
- **31 สิงหาคม 2026 — เตรียมวิดีโอขนาดใหญ่ได้เร็วขึ้น:** การนำเข้าในเครื่องสร้างฟิล์มสตริปตามสมรรถนะคอมพิวเตอร์ วิดีโอออนไลน์จะแสดงความคืบหน้าการดาวน์โหลดจริงก่อน แล้วจึงเตรียมเฟรม ภาพย่อที่แม่นยำจะเติมพื้นที่ที่มองเห็นก่อน จากนั้นค่อยเติมนอกจอแบบแบ่งครึ่งที่จุดกึ่งกลาง และช่องใต้หัวอ่านจะตรงกับเฟรมจริงของภาพตัวอย่างสดเสมอ
- **29 สิงหาคม 2026 — ตัวเชื่อมต่อการสร้างในเครื่อง:** เพิ่มปลั๊กอิน ComfyUI และ Stable Diffusion WebUI/Forge แยกกัน ComfyUI เรียกเวิร์กโฟลว์ API Format ผ่าน loopback และนำเข้าภาพหรือวิดีโอ ส่วน WebUI ใช้ API txt2img/img2img จริง ผลลัพธ์จะเข้า My assets อัตโนมัติ และนำ Hugging Face Spaces แบบทั่วไปออกแล้ว
- **28 สิงหาคม 2026 — ลดนอยส์อัจฉริยะในเบราว์เซอร์:** ภาพ → ซ่อมแซมด้วย AI มี DRUNet พร้อมเปรียบเทียบเฟรม ความแรง 4 ระดับ เก็บเสียงต้นฉบับ และใช้ผลแบบย้อนกลับได้ ทั้งคลิปประมวลผลที่เฟรมเรตต้นฉบับผ่านสตรีม WebCodecs โดยซ้อนการถอดรหัสเฟรมถัดไปกับการอนุมาน ใช้ WebGPU Session แคนวาส เทนเซอร์ และบัฟเฟอร์พิกเซลซ้ำ และใช้ค่าคงเหลือการลดนอยส์อย่างระมัดระวังกับเฟรมข้างเคียงที่เปลี่ยนแปลงน้อย พร้อมทางสำรอง PNG/FFmpeg รองรับเดสก์ท็อป มือถือ และทั้ง 11 ภาษา
