...
- **31 de agosto de 2026 — Preparación más rápida de vídeos grandes:** la importación local crea una tira adaptada al equipo. Los vídeos de la biblioteca muestran primero el progreso real de descarga y después la preparación de fotogramas; una versión acotada y el fotograma inicial exacto evitan un tramo negro artificial. Las miniaturas exactas completan primero la vista visible y luego el resto por subdivisión de puntos medios; la celda bajo el cabezal sigue siempre la imagen de previsualización en vivo.
