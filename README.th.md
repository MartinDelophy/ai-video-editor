...
- **2026-09-26** — สตอรีบอร์ด Sanity: เพิ่มพื้นที่เสริมสำหรับแก้ไขบทและช็อต ตรวจทานและอนุมัติพร้อมตรวจเวอร์ชัน แล้วเพิ่มช็อตลงไทม์ไลน์ด้วยสื่อในเครื่องและบันทึกที่แก้ไขได้ ตัวตัดต่อยังเน้นการทำงานในเครื่อง และส่วนควบคุมใหม่รองรับ 13 ภาษา พื้นที่ที่ปรับใช้ใช้ Astro ร่วมกับส่วนตรวจทาน React เดิม
