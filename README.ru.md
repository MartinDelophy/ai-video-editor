...
- **31 августа 2026 — Ускоренная подготовка больших видео:** локальный импорт создаёт плёнку с плотностью по возможностям компьютера. Онлайн-видео сначала показывают реальный прогресс загрузки, затем подготовку кадров. Точные миниатюры в первую очередь заполняют видимую область, а затем появляются вне неё в порядке деления по серединам; ячейка под курсором всегда повторяет реальный кадр живого предпросмотра.
