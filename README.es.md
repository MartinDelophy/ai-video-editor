...
- **28 de agosto de 2026 — Progreso en tiempo real de los modelos integrados de Chrome:** Edición automática muestra por separado el progreso real de Chrome, el estado de finalización y el número de intento de los modelos de comprensión visual y traducción de subtítulos. Si Chrome no emite progreso durante 45 segundos, muestra un estado bloqueado y una acción Reintentar descarga activada por el usuario, que conserva la descarga parcial y la interacción requerida por Chrome.
- **27 de agosto de 2026 — Edición precisa en la línea de tiempo:** se añadieron deslizamiento de contenido con límites seguros del medio de origen, deslizamiento de tres clips con recorte sincronizado de los vecinos y selección de puntos de edición con ajuste rodante fotograma a fotograma mediante las flechas. Todos los modos mantienen continua la pista visual principal, respetan bloqueos y límites de origen, muestran respuesta en tiempo real y están localizados en 11 idiomas. Las miniaturas verticales y 9:16 ahora rellenan la celda con un recorte centrado, sin bandas negras.
- **26 de agosto de 2026 — Edición de ondulación con bloqueo:** se añadió un modo de ondulación explícito a la barra de la línea de tiempo. Al arrastrar contenido sobre la pista principal se abre antes de soltar un espacio de la misma duración, desplazando juntos los clips posteriores y sus puntos de transición. Los clips principales incorporan un control inicial de edición rodante, y las inserciones de imagen en imagen muestran su duración y posición reales en la fila de destino. La inserción, duplicación, eliminación y los cambios de duración desplazan los clips temporizados aptos por la misma diferencia, conservan los vínculos activos entre subtítulos y audio, derivan el audio de origen vinculado de la secuencia visual y no mueven pistas bloqueadas.
