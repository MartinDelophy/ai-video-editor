...
- **August 24, 2026 — Rhythm click ripple:** added an editable osu!-inspired Effects capability with deterministic random hit positions, music-aware time signatures and quarter-note BPM timing, one refractive full-frame water ripple per hit, synchronized grayscale-to-color propagation, dedicated right-side controls, matched preview/export rendering, and complete localization across all 11 interface languages.
